(async function () {
  ...
  function getEntriesPayloadMeta(entriesOrPayload) {
    ...
    throw new Error("Imported JSON must be an array of entries or an object with an entries array.");
  }

  function validateEntriesPayload(entriesOrPayload) {
    const { entries, defaultInternship } = getEntriesPayloadMeta(entriesOrPayload);
